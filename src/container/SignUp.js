    ...
    <Card className="signupcard">
      ...
      <Form onSubmit={formik.handleSubmit} className="signupform">
        <Row form>
          ...
          <Col md={6}>
            <FormGroup>
              <Label className="signuplabel" for="Father">
                Father Name
              </Label>
              <Input
                onChange={formik.handleChange}
        ...
        <Row form>
          ...
          <Col md={6}>
            <FormGroup>
              ...
              />
              <span style={{ color: "red" }}>{error.passward}</span>
            </FormGroup>
          </Col>
        </Row>
        <Row form>
          <Col md={6}>
            <FormGroup>
              <Label className="signuplabel" for="rePassword">
                Re-Password
              </Label>
              <Input
                onChange={formik.handleChange}
                value={formik.values.rePassward}
                className="signupinput"
                type="password"
                name="rePassward"
                id="rePassword"
              ...
              />
              <span style={{ color: "red" }}>{error.rePassward}</span>
            </FormGroup>
          </Col>
          <Col md={6}>
            <FormGroup>
        ...
        <Row form>
          <Col md={6}>
            <FormGroup>
              <Label className="signuplabel" for="City">
                City
              </Label>
              <Input
                onChange={formik.handleChange}
          ...
          <Col md={6}>
            <FormGroup>
              <Label className="signuplabel" for="State">
                State
              </Label>
              <Input
                onChange={formik.handleChange}
        ...
        <Button onClick={signup} type="submit" className="signupbtn">
          Sign Up
        </Button>
